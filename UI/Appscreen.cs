...
namespace ATM_APP.UI
{
    public class Appscreen
    {
        ...
        internal static void DisplayAppMenu()
        {
            ...
            Console.WriteLine("2.Cash Depoeit                :");
        ...
        internal InternalTransfer InternalTransferForm() //return object, non-static
        {
            var internalTransfer=new InternalTransfer();
            internalTransfer.RecipeintBankAccountNumber = Validator.Convert<long>("recipient's account number: ");
            internalTransfer.TransferAmount = Validator.Convert<decimal>($"amount {cur}");
            internalTransfer.RecipeintBankAccountName = Utility.GetUserInput("recipient's name:");
